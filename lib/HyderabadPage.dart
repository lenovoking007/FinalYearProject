      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Hyderabad offers a diverse shopping experience, from '
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'HyderabadCuisine',
            description:
            'Hyderabad is a food lover\'s delight, known for its rich blend of traditional Deccan flavors and contemporary cuisine.'
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
              ...
              description:
              'Hyderabad hosts a variety of vibrant cultural festivals, '
                  'food events, art exhibitions, and music concerts throughout the year.'
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
