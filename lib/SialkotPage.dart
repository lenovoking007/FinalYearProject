...
class SialkotPage extends StatefulWidget {
  const SialkotPage({super.key});

  @override
  State<SialkotPage> createState() => _SialkotPageState();
}

class _SialkotPageState extends State<SialkotPage> {
  ...
  Widget build(BuildContext context) {
    if (_errorMessage != null) {
      return Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0xFF0066CC),
          title: const Text('Sialkot', style: TextStyle(color: Colors.white)),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            title: 'About Sialkot',
            description:
            'Sialkot, known as the sports and industrial hub of Pakistan, '
                'is a city rich in history and craftsmanship. Famous for its sports goods, '
                'leather products, and surgical instruments, Sialkot offers a unique blend '
                'of traditional culture and modern industry.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Shopping in Sialkot',
            description:
            'Sialkot offers a unique shopping experience, from bustling '
                'local bazaars to modern outlets. The city is famous for its handcrafted sports goods,'
                ' leather products, and surgical instruments.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Sialkot Cuisine',
            description:
            'Sialkot offers a rich culinary experience, known for its delicious street food, '
                'traditional Punjabi dishes, and local sweets like kulfi and jalebi.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    final List<Map<String, dynamic>> festivalLocations = [
      {
        ...
        "details": "An annual festival celebrating local and regional cuisines",
        "image": "assets/images/sialkot/sialkotfes1.jpg"
      },
      {
        "name": "Sialkot Sports Festival",
        "details": "A celebration of Sialkot's sports legacy with competitions",
        "image": "assets/images/sialkot/sialkotfes2.jpg"
      },
      {
        "name": "Iqbal Day Celebrations",
        "details": "Cultural event to commemorate the birth of Allama Iqbal",
        "image": "assets/images/sialkot/sialkotfes4.jpg"
      },
      {
        "name": "Sialkot International Expo",
        "details": "Event focusing on Sialkot's industries with exhibitions",
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
              ...
              description:
              "Sialkot hosts a variety of cultural festivals, traditional food fairs,"
                  " musical gatherings, and local exhibitions throughout the year."
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
        ...
        final List<Map<String, dynamic>> localReviews = [
          {
            ...
            'rating': 5,
            'review': 'Sialkot is a vibrant city with amazing people and delicious food. The sports industry here is world-class!',
          ...
          },
          {
            'name': 'Food Lover',
            'rating': 4,
            'review': 'The food scene in Sialkot is incredible. From street food to fine dining, there\'s something for everyone.',
