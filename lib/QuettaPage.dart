...
class Quettapage extends StatelessWidget {
              ...
              child: TabBarView(
                children: [
                  ...
                  _buildTabContent(
                    ...
                    sectionDescription: 'Quetta is known for its Balochi embroidery, handwoven shawls, and traditional sandals. Explore the bustling markets for authentic Baloch crafts.',
                    activityTitle: 'Top Shopping Spots',
                    activityDescription: '• Liaquat Bazaar: Traditional clothing\n'
                        '• Kandhari Bazaar: Handicrafts & fabrics\n'
                        '• Millat Road: Modern boutiques',
                  ),
                  _buildTabContent(
                    tabName: 'Food',
                    images: foodImages,
                    sectionTitle: 'Quetta Cuisine',
                    sectionDescription: 'Quetta offers hearty and flavorful dishes influenced by Balochi and Afghan culinary traditions.',
                    activityTitle: 'Must-Try Specialties',
                    activityDescription: '• Namkeen Roast\n'
                        '• Sajji (Roasted Lamb)\n'
                        '• Rosh (Slow-cooked Meat)\n'
                        '• Afghani Pulao',
                  ),
                  _buildTabContent(
                    tabName: 'Festival',
                    ...
                    sectionDescription: 'Quetta hosts diverse cultural and traditional festivals reflecting its tribal heritage.',
                    activityTitle: 'Major Events',
                    activityDescription: '• Sibi Festival\n'
                        '• Baloch Culture Day\n'
                        '• Eid Celebrations\n'
                        '• Quetta Flower Show',
                  ),
  ...
  Widget _buildAttractionsGrid() {
    final List<Map<String, dynamic>> attractions = [
      {
        'name': 'Hanna Lake',
        'image': 'assets/images/Quetta/quetta1.jpg',
        'rating': 4.8,
        'reviews': 1320,
      },
      {
        'name': 'Quaid-e-Azam Residency',
        'image': 'assets/images/Quetta/quetta2.jpg',
        'rating': 4.7,
        'reviews': 950,
      },
      {
        'name': 'Askari Park Quetta',
        'image': 'assets/images/Quetta/quetta3.jpg',
        'rating': 4.5,
        'reviews': 710,
      },
      {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildReviewCard(
                name: 'Sana Baloch',
                rating: 5,
                review: 'Hanna Lake is stunning, especially at sunset. A peaceful escape from the city!',
              ...
              _buildReviewCard(
                name: 'Hamza Khan',
                rating: 4,
                review: 'Quaid-e-Azam Residency is full of history. A must-visit for history lovers!',
              ...
              _buildReviewCard(
                name: 'Zara Ali',
                rating: 5,
                review: 'The fresh air and natural beauty at Hazarganji Park are refreshing. Great for families!',
                imageUrl: 'assets/images/Quetta/u3.png',
                date: '2 weeks ago',
              ),
              const SizedBox(height: 16),
              _buildReviewCard(
                name: 'Usman Tariq',
                rating: 4,
                review: 'Askari Park is lively and fun for kids. Quetta has its own unique charm!',
                imageUrl: 'assets/images/Quetta/u4.png',
                date: '3 weeks ago',
              ),
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Share your experience in Quetta...',
                        ),
                      ),
                      const SizedBox(height: 16),
                      Center(
