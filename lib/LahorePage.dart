...
class _LahorePageState extends State<LahorePage> {
  ...
  Future<void> _addCityToCollection() async {
    try {
      final doc = await _firestore.collection('cities').doc('lahore').get();
      if (!doc.exists) {
        await _firestore.collection('cities').doc('lahore').set({
          'name': 'Lahore',
  ...
  Widget build(BuildContext context) {
    if (_errorMessage != null) {
      return Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0xFF0066CC),
          title: const Text('Lahore', style: TextStyle(color: Colors.white)),
  ...
  Widget _buildOverviewTab(BuildContext context) {
    final List<Map<String, dynamic>> attractions = [
      ...
      {
        'name': 'Lahore Fort',
        'address': 'H8Q7+4XH, Fort Rd, Walled City of Lahore, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/lahore2.jpg',
      },
      {
        'name': 'Shalimar Gardens',
        'address': 'G. T. Road, Shalamar Town, Lahore, Punjab, Pakistan',
  ...
  Widget _buildShoppingTab() {
    final List<Map<String, dynamic>> shoppingSpots = [
      {
        'name': 'Packages Mall',
        'address': 'Main Boulevard, Block L Gulberg III, Lahore, Punjab 54660, Pakistan',
        'image': 'assets/images/Lahore/cl1.jpg',
      },
      {
        'name': 'Emporium Mall',
        'address': 'Abdul Haque Rd, Block H 3 Phase 1 Johar Town, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/cl2.jpg',
      },
      {
        'name': 'Liberty Market',
        'address': 'Main Boulevard Gulberg, near Mini Market, Block C2 Block C 2 Gulberg III, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/cl3.jpg',
      },
      {
        'name': 'Anarkali Bazaar',
        'address': 'Anarkali Bazaar, Anarkali, Lahore, Punjab, Pakistan',
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Lahore offers a wide range of traditional and modern clothing options. '
                'The bazaars are filled with colorful fabrics, bridal wear, and handcrafted accessories.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
  ...
  Widget _buildFoodTab() {
    final List<Map<String, dynamic>> foodLocations = [
      ...
      },
      {
        ...
        'address': 'Fort Rd, Walled City of Lahore, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/food2.jpeg',
      },
      {
        'name': 'Cooco\'s Den',
        'address': 'Haveli Barood Khana, Fort Rd, Walled City of Lahore, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/food3.jpg',
      },
      {
        'name': 'BBQ Tonight',
        'address': 'Main Boulevard, Block L Gulberg III, Lahore, Punjab 54660, Pakistan',
        'image': 'assets/images/Lahore/food4.jpg',
      },
    ];
  ...
  Widget _buildFestivalTab() {
    final List<Map<String, dynamic>> festivalLocations = [
      {
        'name': 'Wagha Border',
        'address': 'Grand Trunk Rd, Wagah, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/f1.jpg',
      },
      {
        'name': 'Minar-e-Pakistan',
        'address': 'Iqbal Park, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/f2.jpg',
      },
      {
        'name': 'Alhamra Arts Council',
        'address': 'Shahrah-e-Quaid-e-Azam, Lahore, Punjab 54000, Pakistan',
        'image': 'assets/images/Lahore/f3.jpg',
      },
      {
        'name': 'Shah Jamal Shrine',
        'address': 'Shah Jamal Rd, Lahore, Punjab, Pakistan',
        'image': 'assets/images/Lahore/f4.jpg',
      },
    ];
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Lahore hosts a variety of festivals throughout the year that showcase its rich culture and traditions.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
