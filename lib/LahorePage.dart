...
class LahorePage extends StatelessWidget {
  ...
  Widget _buildAttractionsGrid() {
    final List<Map<String, dynamic>> attractions = [
      ...
      {
        'name': 'Lahore Fort',
        'address': 'Near Badshahi Mosque, Lahore',
      ...
      {
        'name': 'Food Street',
        'address': 'Near Anarkali Bazaar, Lahore',
    ...
    final List<Map<String, dynamic>> foodLocations = [
      {
        ...
        'details': 'A hub for traditional Lahori cuisine.',
        'image': 'assets/images/Lahore/food1.jpg',
      },
      {
        'name': 'Fort Road Food Street',
        'details': 'Famous for Nihari and other local delicacies.',
        'image': 'assets/images/Lahore/food2.jpeg',
      },
      {
        'name': 'Cooco\'s Den',
        'details': 'Renowned for its unique fusion dishes.',
        'image': 'assets/images/Lahore/food3.jpg',
      },
      {
        'name': 'BBQ Tonight',
        'details': 'Best place for BBQ and grilled dishes.',
  ...
  Widget _buildFestivalGrid() {
    final List<Map<String, dynamic>> festivalLocations = [
      {
        'name': 'Wagha Border',
        'details': 'Witness the iconic lowering of flags ceremony.',
        'image': 'assets/images/Lahore/f1.jpg',
      },
      {
        'name': 'Minar-e-Pakistan',
        'details': 'Hosts cultural events and festivals throughout the year.',
        'image': 'assets/images/Lahore/f2.jpg',
      },
      {
        'name': 'Alhamra Arts Council',
        'details': 'Venue for art exhibitions and music concerts.',
        'image': 'assets/images/Lahore/f3.jpg',
      },
      {
        'name': 'Shah Jamal Shrine',
        'details': 'Famous for Dhamal and spiritual gatherings.',
