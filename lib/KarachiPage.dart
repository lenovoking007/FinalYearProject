...
<<<<<<< HEAD
                  _buildTabContent(
                    ...
                    sectionDescription: 'Karachi offers a mix of traditional and contemporary clothing styles. Explore high-end boutiques and local markets with quality fabrics.',
                    activityTitle: 'Shopping Destinations',
                    activityDescription: '• Dolmen Mall: International brands\n'
                        '• Zainab Market: Local designers\n'
                        '• Tariq Road Bazaar: Affordable fashion',
                  ),
                  _buildTabContent(
                    tabName: 'Food',
                    images: foodImages,
                    sectionTitle: 'Karachi Cuisine',
                    sectionDescription: 'Savor diverse flavors from spicy street food to international gourmet in Pakistan\'s culinary capital.',
                    activityTitle: 'Must-Try Experiences',
                    activityDescription: '• Bun Kebabs at Burns Road\n'
                        '• BBQ at BBQ Tonight\n'
                        '• Seafood at Kolachi Restaurant\n'
                        '• Fine dining at Do Darya',
                  ),
                  _buildTabContent(
                    tabName: 'Festival',
                    images: festivalImages,
                    sectionTitle: 'Cultural Events',
                    sectionDescription: 'Karachi celebrates a vibrant mix of cultural, religious, and community festivals year-round.',
                    activityTitle: 'Key Festivals',
                    activityDescription: '• Karachi Literature Festival\n'
                        '• Eid Milad-un-Nabi Grand Processions\n'
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'Karachi, Pakistan\'s coastal metropolis, is renowned for its vibrant energy, '
                        'cultural diversity, and economic significance. Stretching along the Arabian Sea, '
                        'it presents a dynamic mix of historic landmarks and modern commercial hubs.',
...
<<<<<<< HEAD
  Widget _buildAttractionsGrid() {
    final List<Map<String, dynamic>> attractions = [
      {
        'name': 'Mazar-e-Quaid',
        'image': 'assets/images/Karachi/karachi1.jpg',
        'rating': 4.8,
        'reviews': 1789,
      },
      {
        'name': 'Clifton Beach',
        'image': 'assets/images/Karachi/karachi2.jpg',
        'rating': 4.6,
        'reviews': 1543,
      },
      {
        'name': 'Mohatta Palace',
        'image': 'assets/images/Karachi/karachi3.jpg',
        'rating': 4.4,
        'reviews': 921,
      },
      {
        'name': 'Pakistan Maritime Museum',
        'image': 'assets/images/Karachi/karachi4.jpg',
        'rating': 4.7,
        'reviews': 1320,
      },
    ];
          ...
          child: Column(
            ...
            children: [
              ...
              _buildReviewCard(
                name: 'Amina Khan',
                rating: 5,
                review: 'Clifton Beach at sunset is breathtaking! The city\'s energy and diversity amazed me.',
                imageUrl: 'assets/images/Karachi/u1.png',
                date: '3 days ago',
              ),
              const SizedBox(height: 16),
              _buildReviewCard(
                name: 'Farhan Ahmed',
                rating: 4,
                review: 'Perfect blend of history and modernity. Don\'t miss the Quaid\'s Mausoleum!',
                imageUrl: 'assets/images/Karachi/u2.png',
                date: '1 week ago',
              ),
              const SizedBox(height: 16),
              _buildReviewCard(
                name: 'Sophie Martin',
                rating: 5,
                review: 'Loved the vibrant street life and coastal breeze. A city that never sleeps!',
                imageUrl: 'assets/images/Karachi/u3.png',
                date: '2 weeks ago',
              ),
              const SizedBox(height: 16),
              _buildReviewCard(
                name: 'Bilal Siddiqui',
                rating: 4,
                review: 'Amazing food culture - Burns Road street food is a must-try experience!',
                imageUrl: 'assets/images/Karachi/u4.png',
                date: '1 month ago',
              ),
              const SizedBox(height: 24),
              Padding(
