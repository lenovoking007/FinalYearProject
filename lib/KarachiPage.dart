      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
                'Karachi offers a diverse shopping experience, from '
                    'luxurious malls to traditional markets. You can find everything from designer brands to handcrafted goods.'
            ,
          ),
          const SizedBox(height: 24),
          Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'karachi is a food lover\'s paradise, offering a mix of traditional Pakistani dishes and modern culinary delights.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Karachi hosts a wide range of cultural festivals, '
                'food events, music concerts, and international exhibitions throughout the year.'
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
  ...
  Widget _buildAttractionsGrid() {
    final List<Map<String, dynamic>> attractions = [
      ...
      },
      {
        ...
        'image': 'assets/images/Karachi/maritime_museum.jpg',
      },
    ];
