...
class RawalpindiPage extends StatefulWidget {
  const RawalpindiPage({super.key});

  @override
  State<RawalpindiPage> createState() => _RawalpindiPageState();
}

class _RawalpindiPageState extends State<RawalpindiPage> {
  ...
  Widget build(BuildContext context) {
    if (_errorMessage != null) {
      return Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0xFF0066CC),
          title: const Text('Rawalpindi', style: TextStyle(color: Colors.white)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'About Rawalpindi',
            description:
            'Rawalpindi, the twin city of Islamabad, is a bustling metropolis with a rich military '
                'and colonial history. Known as "Pindi" to locals, it offers a vibrant bazaar culture, '
                'historic landmarks, and serves as the gateway to the scenic hill stations of Murree '
                'and Nathia Gali.',
          ),
          const SizedBox(height: 24),
          Padding(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Shopping in Rawalpindi',
            description:
            'Rawalpindi offers diverse shopping experiences from traditional bazaars to modern '
                'shopping centers. The city is famous for its military-themed souvenirs, traditional '
                'Punjabi juttis (shoes), and colorful fabrics at reasonable prices.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Rawalpindi Cuisine',
            description:
            'Rawalpindi offers a rich culinary experience with its famous street food, traditional '
                'Punjabi dishes, and military-style dhabas. Must-try items include Pindi chana, '
                'seekh kebabs, and the famous "Pindi wala" nihari.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
              ...
              description:
              "Rawalpindi hosts various cultural and military-themed events throughout the year, "
                  "celebrating both traditional Punjabi culture and its significance as a major "
      ...
      builder: (context, snapshot) {
        ...
        final List<Map<String, dynamic>> localReviews = [
          ...
          },
          {
            'name': 'Food Explorer',
            'rating': 4,
            'review': 'The street food in Raja Bazaar is incredible. Must try the Pindi chana and seekh kebabs!',
