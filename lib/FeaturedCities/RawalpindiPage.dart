...
class RawalpindiPage extends StatelessWidget {
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(
                              Icons.flight_takeoff, color: Color(0xFF0066CC),
                              size: 28),
                      ...
                      const SizedBox(height: 16),
                      _buildEditableTextField(
                          "Number of People", peopleCountController,
                          Icons.people),
                      const SizedBox(height: 16),
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          return isSmallScreen
                            ...
                            children: [
                              _buildDateSelector(
                                  context, "Start Date", startDate, (picked) {
                                if (picked != null) {
                                  setState(() {
                                    startDate = picked;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Icon(
                    Icons.calendar_today, size: 16, color: Color(0xFF0066CC)),
                const SizedBox(width: 8),
                Text(
  ...
  void _showSuccessDialog(BuildContext context, String tripName,
      String tripType, int duration) {
    showDialog(
      context: context,
      builder: (context) =>
          Dialog(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(
                          Icons.search, color: Colors.white, size: 20),
                      border: InputBorder.none,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Rawalpindi is a historic city known for its rich military heritage, beautiful landscapes, and proximity to Islamabad.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Rawalpindi offers a mix of traditional markets and modern shopping malls, perfect for fashion lovers.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Rawalpindi’s food scene blends street food culture with fine dining, offering everything from kebabs to biryani.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Rawalpindi hosts several cultural events, including local fairs and national celebrations.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
            ...
            children: [
              ...
              ...reviews.map((reviewDoc) {
                ...
                return _buildReviewCard(
                  ...
                  imageUrl: 'assets/images/Rawalpindi/u1.png',
                  date: reviewData['timestamp'] != null
                      ? '${DateTime
                      .now()
                      .difference(reviewData['timestamp'].toDate())
                      .inDays} days ago'
                      : 'Unknown date',
                );
              }).toList(),
