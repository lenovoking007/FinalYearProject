      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Peshawar, one of the oldest cities in South Asia, is a gateway to Khyber Pakhtunkhwa’s rich history and culture.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Peshawar offers traditional Pashtun clothing such as Shalwar Qameez, turbans, and handcrafted jewelry.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Peshawar is famous for its unique blend of Pashtun and Mughal cuisine, especially dishes like Chapli Kabab and Roghani Naan.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Peshawar hosts various cultural and religious festivals that reflect the vibrant heritage of the region.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
