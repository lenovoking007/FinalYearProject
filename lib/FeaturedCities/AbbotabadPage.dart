...
class AbbottabadPage extends StatelessWidget {
  final List<String> overviewImages = [
    'assets/images/Abbottabad/abbottabad1.jpg',
    'assets/images/Abbottabad/abbottabad2.jpg',
    'assets/images/Abbottabad/abbottabad3.jpg',
  ];
  final List<String> clothesImages = [
    'assets/images/Abbottabad/cl1.jpg',
    'assets/images/Abbottabad/cl2.jpg',
    'assets/images/Abbottabad/cl3.jpg',
    'assets/images/Abbottabad/cl4.jpg',
  ];
  final List<String> foodImages = [
    'assets/images/Abbottabad/food1.jpg',
    'assets/images/Abbottabad/food2.jpg',
    'assets/images/Abbottabad/food3.jpg',
    'assets/images/Abbottabad/food4.jpg',
  ];
  final List<String> festivalImages = [
    'assets/images/Abbottabad/f1.jpg',
    'assets/images/Abbottabad/f2.jpg',
    'assets/images/Abbottabad/f3.jpg',
    'assets/images/Abbottabad/f4.jpg',
  ];

  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  final FirebaseAuth _auth = FirebaseAuth.instance;

  AbbottabadPage({super.key});
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _buildSuccessDetailRow("Destination:", "Abbottabad"),
                    const Divider(height: 16, thickness: 0.5),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'About Abbottabad',
            description:
            'Abbottabad is a hill station located in Khyber Pakhtunkhwa, known for its scenic beauty, pleasant weather, and historical significance.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Abbottabad offers a mix of traditional markets and modern stores where you can buy local handicrafts and trendy outfits.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Abbottabad Cuisine',
            description:
            'The city serves a variety of cuisines ranging from street food to fine dining, including local delicacies and fast food.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Abbottabad celebrates several cultural and seasonal events that reflect the region’s heritage and traditions.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
            ...
            children: [
              ...
              ...reviews.map((reviewDoc) {
                ...
                return _buildReviewCard(
                  ...
                  imageUrl: 'assets/images/Abbottabad/u1.png',
  ...
  Widget _buildAttractionsGrid() {
    final List<Map<String, dynamic>> attractions = [
      {'name': 'Ayub National Park', 'address': 'Near City Center', 'image': 'assets/images/Abbottabad/abbottabad1.jpg'},
      {'name': 'Ghora Gali', 'address': 'Near Murree Road', 'image': 'assets/images/Abbottabad/abbottabad2.jpg'},
      {'name': 'Hund Museum', 'address': 'On Karakoram Highway', 'image': 'assets/images/Abbottabad/abbottabad3.jpg'},
      {'name': 'Keenjhar Lake', 'address': 'In Mansehra District', 'image': 'assets/images/Abbottabad/abbottabad2.jpg'},
    ];
  ...
  Widget _buildShoppingGrid() {
    final List<Map<String, dynamic>> shoppingSpots = [
      {'name': 'Karakoram Market', 'details': 'Traditional market with local goods.', 'image': 'assets/images/Abbottabad/cl1.jpg'},
      {'name': 'Mall Road Bazaar', 'details': 'Historic shopping area.', 'image': 'assets/images/Abbottabad/cl2.jpg'},
      {'name': 'Alpine Plaza', 'details': 'Modern mall with fashion stores.', 'image': 'assets/images/Abbottabad/cl3.jpg'},
      {'name': 'Chandni Chowk', 'details': 'Famous for jewelry and gifts.', 'image': 'assets/images/Abbottabad/cl4.jpg'},
    ];
    return GridView.builder(
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
  ...
  Widget _buildFoodGrid() {
    final List<Map<String, dynamic>> foodLocations = [
      {'name': 'BBQ Tonight', 'details': 'Best place for grilled dishes.', 'image': 'assets/images/Abbottabad/food1.jpg'},
      {'name': 'Biryani House', 'details': 'Hyderabadi-style biryani.', 'image': 'assets/images/Abbottabad/food2.jpg'},
      {'name': 'Tea Stall', 'details': 'Classic local tea spot.', 'image': 'assets/images/Abbottabad/food3.jpg'},
      {'name': 'Shangrila Restaurant', 'details': 'Scenic view with good food.', 'image': 'assets/images/Abbottabad/food4.jpg'},
    ];
    return GridView.builder(
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
  ...
  Widget _buildFestivalGrid() {
    final List<Map<String, dynamic>> festivalLocations = [
      {'name': 'Pakistan Day Parade', 'details': 'March 23rd at Cadet College.', 'image': 'assets/images/Abbottabad/f1.jpg'},
      {'name': 'Independence Day', 'details': 'August 14th fireworks.', 'image': 'assets/images/Abbottabad/f2.jpg'},
      {'name': 'Winter Carnival', 'details': 'Seasonal fun fair.', 'image': 'assets/images/Abbottabad/f3.jpg'},
      {'name': 'Local Fairs', 'details': 'Cultural and folk music events.', 'image': 'assets/images/Abbottabad/f4.jpg'},
    ];
    return GridView.builder(
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
