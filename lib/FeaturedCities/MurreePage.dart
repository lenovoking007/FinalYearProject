      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            ...
            items: ['Adventure', 'Relaxation', 'Cultural', 'Wildlife', 'Family']
                .map((String type) {
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _buildSuccessDetailRow("Destination:", "Murree"),
                    const Divider(height: 16, thickness: 0.5),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            title: 'About Murree',
            description:
            'Murree is a scenic hill station located in Punjab, known for its cool climate, beautiful landscapes, and colonial architecture.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Murree offers cozy shops with woolen wear, handmade crafts, and souvenirs perfect for gifting.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Murree Cuisine',
            description:
            'Murree’s food scene includes cozy cafes, traditional dhabas, and fast-food joints offering both local and continental dishes.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Murree hosts various seasonal festivals and cultural events that attract tourists year-round.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
            ...
            children: [
              ...
              ...reviews.map((reviewDoc) {
                ...
                return _buildReviewCard(
                  ...
                  imageUrl: 'assets/images/Murree/u1.png',
