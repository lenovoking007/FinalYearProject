...
class IslamabadPage extends StatelessWidget {
              ...
              child: TabBarView(
                children: [
                  ...
                  _buildTabContent(
                    ...
                    sectionDescription: 'Islamabad offers a mix of traditional and contemporary clothing styles. Explore high-end boutiques and local markets with quality fabrics.',
                    activityTitle: 'Shopping Destinations',
                    activityDescription: '• Centaurus Mall: International brands\n'
                        '• Jinnah Super Market: Local designers\n'
                        '• Sunday Bazaar: Affordable fashion',
                  ),
                  _buildTabContent(
                    tabName: 'Food',
                    images: foodImages,
                    sectionTitle: 'Islamabad Cuisine',
                    sectionDescription: 'Experience diverse dining options from traditional Pakistani to international cuisines in the capital city.',
                    activityTitle: 'Must-Try Experiences',
                    activityDescription: '• Chapli Kebabs at Savour Foods\n'
                        '• Traditional Dhabas on Murree Road\n'
                        '• Fine dining at Monal Restaurant\n'
                        '• Street food in Blue Area',
                  ),
                  _buildTabContent(
                    tabName: 'Festival',
                    images: festivalImages,
                    sectionTitle: 'Cultural Events',
                    sectionDescription: 'Islamabad hosts various cultural and national events throughout the year.',
                    activityTitle: 'Key Festivals',
                    activityDescription: '• Pakistan Day Parade (23rd March)\n'
                        '• Islamabad Literature Festival\n'
                        '• Lok Virsa Folk Festival\n'
                        '• Margalla Hills Hiking Festival',
                  ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Islamabad, Pakistan\'s modern capital, is known for its scenic beauty, '
                        'well-planned infrastructure, and diplomatic enclaves. Nestled against '
                        'the Margalla Hills, it offers a perfect blend of natural beauty and urban development.',
  ...
  Widget _buildAttractionsGrid() {
    final List<Map<String, dynamic>> attractions = [
      {
        'name': 'Faisal Mosque',
        'image': 'assets/images/Islamabad/islamabad1.jpg',
        'rating': 4.9,
        'reviews': 1567,
      },
      {
        'name': 'Daman-e-Koh',
        'image': 'assets/images/Islamabad/islamabad2.jpg',
        'rating': 4.7,
        'reviews': 1345,
      },
      {
        'name': 'Lok Virsa Museum',
        'image': 'assets/images/Islamabad/islamabad3.jpg',
        'rating': 4.5,
        'reviews': 876,
      },
      {
        'name': 'Margalla Hills',
        'image': 'assets/images/Islamabad/food1.jpg',
        'rating': 4.8,
        'reviews': 1987,
      },
    ];
          ...
          child: Column(
            ...
            children: [
              ...
              _buildReviewCard(
                name: 'Sarah Johnson',
                rating: 5,
                review: 'Faisal Mosque at sunset is magical! The city\'s greenery and cleanliness surprised me.',
                imageUrl: 'assets/images/Islamabad/u1.png',
                date: '3 days ago',
              ),
              const SizedBox(height: 16),
              _buildReviewCard(
                name: 'Ahmed Raza',
                rating: 4,
                review: 'Perfect mix of modern and natural. Margalla Hills hiking trails are a must-do!',
                imageUrl: 'assets/images/Islamabad/u2.png',
                date: '1 week ago',
              ),
              const SizedBox(height: 16),
              _buildReviewCard(
                name: 'Emma Wilson',
                rating: 5,
                review: 'Loved the serene environment and well-maintained parks. A peaceful capital city.',
                imageUrl: 'assets/images/Islamabad/u3.png',
                date: '2 weeks ago',
              ),
              const SizedBox(height: 16),
              _buildReviewCard(
                name: 'Ali Khan',
                rating: 4,
                review: 'Great food scene with both local and international options. Monal Restaurant views are breathtaking!',
                imageUrl: 'assets/images/Islamabad/u4.png',
                date: '1 month ago',
              ),
              const SizedBox(height: 24),
              Padding(
