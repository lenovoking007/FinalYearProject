...
class _IslamabadPageState extends State<IslamabadPage> {
  ...
  Widget build(BuildContext context) {
    if (_errorMessage != null) {
      return Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0xFF0066CC),
          title: const Text('Islamabad', style: TextStyle(color: Colors.white)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'About Islamabad',
            description:
            'Islamabad, Pakistan\'s capital city, is known for its scenic beauty, '
                'modern architecture, and peaceful environment. Nestled against the Margalla Hills, '
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Islamabad offers a mix of modern malls and traditional markets. '
                'From high-end international brands to local handicrafts, you can find diverse '
                'shopping options throughout the city.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Islamabad Cuisine',
            description:
            'Islamabad offers a diverse food scene with influences from all '
                'over Pakistan. From traditional desi cuisine to international flavors, '
                'the city has something for every palate.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Islamabad hosts numerous cultural festivals throughout the year, '
                'celebrating the diverse heritage of Pakistan through music, dance, food, '
  ...
  Widget _buildReviewFeedbackTab() {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore
          .collection('reviews')
          .where('destination', isEqualTo: 'Islamabad')
