...
class GwadarPage extends StatefulWidget {
  const GwadarPage({super.key});

  @override
  State<GwadarPage> createState() => _GwadarPageState();
}

class _GwadarPageState extends State<GwadarPage> {
  ...
  Widget build(BuildContext context) {
    if (_errorMessage != null) {
      return Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0xFF0066CC),
          title: const Text('Gwadar', style: TextStyle(color: Colors.white)),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            title: 'About Gwadar',
            description:
            'Gwadar is a port city on the southwestern coast of Balochistan, known for its deep-sea port '
                'and stunning coastal landscapes. As the centerpiece of the China-Pakistan Economic Corridor, '
                'Gwadar is transforming into a modern city while retaining its natural beauty. The city offers '
                'pristine beaches, unique rock formations, and a glimpse into traditional Makrani culture.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Gwadar showcases traditional Makrani and Balochi clothing including embroidered '
                'shawls, loose-fitting shirts, and turbans. The city is particularly known for '
                'its colorful traditional dresses adorned with intricate mirror work and '
                'handmade jewelry that reflects the coastal culture.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Gwadar Cuisine',
            description:
            'Gwadar offers a unique coastal culinary tradition with specialties like fresh seafood, '
                'including grilled fish, prawns, and lobster. The city is also known for its '
                'traditional Balochi dishes like Sajji and Dampukht. The flavors are a blend of '
                'coastal ingredients and traditional Balochi spices.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
              ...
              description:
              "Gwadar hosts several festivals celebrating its coastal culture and development. "
                  "The Gwadar Cultural Festival is the most famous, featuring traditional performances, "
                  "boat races, and crafts. The city also celebrates its fishing heritage and the "
                  "development milestones of the China-Pakistan Economic Corridor."
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      builder: (context, snapshot) {
        ...
        final List<Map<String, dynamic>> firestoreReviews = reviewDocs.map((doc) {
          ...
          return {
            ...
            'imageUrl': 'assets/images/gwadar/u${(doc.hashCode % 3) + 1}.png',
        ...
        final List<Map<String, dynamic>> localReviews = [
          {
            'name': 'Beach Explorer',
            'rating': 5,
            'review': 'Gwadar\'s beaches are absolutely stunning! The clear blue waters are unforgettable.',
            'imageUrl': 'assets/images/gwadar/u1.png',
            'date': '3 months ago'
          },
          {
            'name': 'Development Watcher',
            'rating': 4,
            'review': 'Fascinating to see Gwadar transforming while maintaining its natural beauty.',
