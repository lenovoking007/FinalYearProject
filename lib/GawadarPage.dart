      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
              title: 'About Gawadar',
              description:
              "Gwadar, the coastal gem of Pakistan, is a blend of natural beauty, "
                  "rich cultural heritage, and a growing hub of modern development."
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
              ...
              description:
              "Gwadar offers a unique shopping experience with "
                  "traditional handicrafts, seashell products, and locally made items,"
                  " reflecting the region’s rich cultural heritage and coastal craftsmanship."
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Gawadar Cuisine',
            description:
            "Gwadar is a food lover's paradise, famous for its fresh seafood,"
                " traditional Balochi dishes, and locally grown fruits like dates and melons."
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
              ...
              description:
              "Gwadar hosts vibrant cultural festivals, local craft exhibitions, music performances, and"
                  " traditional celebrations that highlight the city’s rich heritage and coastal craftsmanship."),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
            child: Text(
