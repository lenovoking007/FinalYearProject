...
class CamelSafariPage extends StatelessWidget {
  final List<String> overviewImages = [
    'assets/images/CamelSafari/overview1.jpg',
    'assets/images/CamelSafari/overview2.jpg',
    'assets/images/CamelSafari/overview3.jpg',
  ];

  final List<String> naturalSpotsImages = [
    'assets/images/CamelSafari/nature1.jpg',
    'assets/images/CamelSafari/nature2.jpg',
    'assets/images/CamelSafari/nature3.jpg',
  ];

  final List<String> safetyImages = [
    'assets/images/CamelSafari/safety1.jpg',
    'assets/images/CamelSafari/safety2.jpg',
    'assets/images/CamelSafari/safety3.jpg',
  ];

  CamelSafariPage({super.key});
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            indicatorWeight: 3,
            tabs: const [
              Tab(icon: Icon(Icons.pets), text: 'Overview'),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            title: 'Experience the Camel Safari Adventure',
            description:
            'Join a unique adventure riding camels through the desert. Discover the thrill of exploring vast sand dunes while riding on the back of a camel.',
          ),
          const SizedBox(height: 24),
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 8),
            child: Text(
              'Best Camel Safari Locations',
              style: TextStyle(
                fontSize: 20,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          _buildInfoCard(
            title: 'Top Camel Safari Locations',
            description:
            'Explore some of the best places to enjoy camel rides, where you can experience the beauty of the desert landscapes.',
          ),
          const SizedBox(height: 24),
          Padding(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          _buildInfoCard(
            title: 'Camel Safari Safety Tips',
            description:
            'Ensure your safety while riding camels in the desert by following these important tips and recommendations.',
          ),
          const SizedBox(height: 24),
  ...
  Widget _buildSafetyTipsList() {
    final List<String> tips = [
      ...
      'Keep a safe distance from camels during the safari.',
    ];
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Text(
              'Essential Camel Safari Safety Tips',
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.bold,
                color: Color(0xFFFD7C00),
