...
class FaisalabadPage extends StatefulWidget {
  const FaisalabadPage({super.key});

  @override
  State<FaisalabadPage> createState() => _FaisalabadPageState();
}

class _FaisalabadPageState extends State<FaisalabadPage> {
  ...
  Widget build(BuildContext context) {
    if (_errorMessage != null) {
      return Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0xFF0066CC),
          title: const Text('Faisalabad', style: TextStyle(color: Colors.white)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'About Faisalabad',
            description:
            'Faisalabad, known as the "Manchester of Pakistan," is the third-largest city in the country. '
                'It is famous for its textile industry, agricultural production, and vibrant bazaars. '
                'The city is laid out in a unique eight-radial pattern with the iconic Clock Tower at its center.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Shopping in Faisalabad',
            description:
            'Faisalabad is a shopper\'s paradise, especially for textiles and fabrics. '
                'The city offers everything from traditional bazaars selling handmade crafts to '
                'modern malls with international brands. Faisalabad is particularly famous for '
                'its high-quality cotton fabrics and ready-to-wear garments.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard(
            title: 'Faisalabad Cuisine',
            description:
            'Faisalabad offers a rich culinary experience with a focus on traditional Punjabi cuisine. '
                'The city is famous for its street food, especially gol gappay, samosas, and chaat. '
                'Main dishes include various types of karahi, biryani, and tandoori specialties.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            description:
            'Faisalabad hosts various cultural and industrial festivals throughout the year. '
                'The most prominent is the Lyallpur Festival, which celebrates the city\'s history and culture. '
                'Industrial expos showcase Faisalabad\'s economic importance in textiles and manufacturing.',
          ),
          const SizedBox(height: 24),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
